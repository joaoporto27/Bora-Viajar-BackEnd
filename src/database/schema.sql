...
(12, 'Pacotes exclusivos para o verão disponíveis agora', 'promoção'),
(7, 'Novos roteiros internacionais com descontos especiais', 'promoção'),
(19, 'Viagem dos sonhos? Temos o pacote ideal pra você', 'promoção'),
(25, 'Ofertas limitadas para destinos exóticos', 'promoção'),
(6, 'Atualização de segurança para voos internacionais', 'alerta'),
(17, 'Nevasca afeta rotas de viagem em regiões alpinas', 'alerta'),
(38, 'Surpresa especial: upgrade gratuito em pacotes selecionados', 'novidades'),
(5, 'Anúncio: novos pacotes para o outono disponíveis', 'novidades'),
(31, 'Descontos relâmpago para quem ama viajar', 'promoção'),
(13, 'Condições de tempo adversas cancelam excursões marítimas', 'alerta'),
(8, 'Promoção especial para reservas antecipadas', 'promoção'),
(27, 'Viagens de última hora com até 40% de desconto', 'promoção'),
(20, 'Atualização: novas rotas adicionadas aos nossos destinos', 'novidades'),
(36, 'Chuva intensa causa atrasos em aeroportos', 'alerta'),
(22, 'Aproveite: promoções semanais para destinos nacionais', 'promoção'),
(40, 'Promoção especial para grupos e famílias', 'promoção'),
(3, 'Alerta de greves no setor de transporte aéreo', 'alerta'),
(14, 'Nova funcionalidade no app de viagens: planejamento automático', 'novidades'),
(35, 'Confira nossos pacotes all inclusive com superdesconto', 'promoção'),
(2, 'Eventos culturais incluídos nos pacotes de primavera', 'novidades'),
(11, 'Alerta: greve de funcionários afeta aeroportos na Europa', 'alerta'),
(24, 'Imperdível: combos de viagem com hospedagem gratuita', 'promoção'),
(39, 'Explore novos destinos com nossos pacotes atualizados', 'novidades'),
(9, 'Promoção especial para destinos históricos na América do Sul', 'promoção'),
(18, 'Frio intenso altera itinerários de viagem no sul do país', 'alerta'),
(5, 'Agora com mais opções de pagamento para sua viagem', 'novidades'),
(30, 'Descubra pacotes de ecoturismo com até 50% de desconto', 'promoção'),
(21, 'Ofertas inéditas para destinos internacionais exóticos', 'promoção'),
(26, 'Fique atento: mudanças no embarque de voos domésticos', 'alerta'),
(7, 'Atualização nos protocolos de segurança para viajantes', 'novidades'),
(23, 'Participe do sorteio de viagens para o Caribe', 'promoção'),
(14, 'Novos roteiros gastronômicos adicionados ao catálogo', 'novidades'),
(41, 'Calor extremo pode impactar atividades ao ar livre', 'alerta'),
(1, 'Aproveite o festival de descontos em viagens nacionais', 'promoção'),
(16, 'Reabertura de destinos populares após restrições', 'novidades'),
(32, 'Confira nossos novos pacotes temáticos para famílias', 'novidades'),
(37, 'Fortes ventos causam suspensão temporária de voos', 'alerta'),
(33, 'Promoção especial de inverno para destinos na serra', 'promoção'),
(10, 'Roteiros exclusivos para lua de mel com desconto', 'promoção'),
(6, 'Atenção: mudanças nos vistos para viagens internacionais', 'alerta');
